...
std::vector<double> Optimizer::checkConvexForESingle4(
...
std::vector<double> Optimizer::checkConvexForEArray(
const int grid_asses[],
const int cluster_labels[],
const int &N, const int &num, const int &square_len, const int &maxLabel,
...
std::vector<double> Optimizer::checkConvexForE(
...
void Optimizer::getCostMatrixForEArrayToArray(
int grid_asses[],
int cluster_labels[],
...
std::vector<std::vector<double>> Optimizer::getCostMatrixForE(
const std::vector<int> &_grid_asses,
const std::vector<int> &_cluster_labels) {
    int N = _grid_asses.size();
    int num = _cluster_labels.size();
...
std::vector<double> Optimizer::checkCostForE(
