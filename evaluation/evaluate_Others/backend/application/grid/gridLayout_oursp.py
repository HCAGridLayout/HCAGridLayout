...
class GridLayout(object):
    ...
    def grid(self, labels, X_feature, true_id, hierarchy, top_labels, filter_labels=None, info_before=None, P=None, scale=1/2, confs_hierarchy=None, shres=0.8):
        ...
        grid_asses, grid_new = AssignQAP(np.arange(N, dtype='int'), np.zeros(N, dtype='int'), feature=X_feature, scale=scale, _maxit=40)
        ...
        name = "oursp" + "_" + self.Ctrler.scenario + "_" + self.Ctrler.dataset
